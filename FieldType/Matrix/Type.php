 ...
 * 
 * Example:
 * $field_value = array('prices' => array( 'rows' => array( array('price_categories' => '3klass', 'prices' => '80'), 
 *                                                          array( 'price_categories' => '4klass', 'prices' => '90')
 *                                                         ),
 *                                         'columns' => array( array('id' => 'price_categories','name' => 'Preiskategorien','num' => 0),
 *                                                             array('id' => 'prices','name' => 'Preise','num' => 1)
 *                                                            )
 *                                       )
 *                     );
 * $this->contentService->newContentUpdateStruct()->setField($field_name, new Matrix\Value($field_value['rows'],$field_value['columns']));
 */
